...
const OUT = '/tmp/claude-0/-home-user-gta-chinatown-casa/1d365fc6-c319-529a-842f-29b164bb8181/scratchpad/full_capture_raw.mp4';
  ...
  (async () => {
    ...
    await p.evaluate(() => new Promise(resolve => {
      window.__rec.onstop = () => {
        ...
        a.download = 'full_capture_raw.mp4';
